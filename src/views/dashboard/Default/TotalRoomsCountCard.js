            ...
            <Grid container direction="column">
              ...
              <Grid item>
                <Grid container alignItems="center">
                  <Grid item>
                    <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 4, mb: 0.75 }}>{totalRoomsCount}</Typography>
                  </Grid>
...
TotalRoomsCountCard.propTypes = {
  isLoading: PropTypes.bool
};

export default TotalRoomsCountCard;
